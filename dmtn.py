...
class DMTN:
    ...
    def __init__(self, babi_train_raw, babi_test_raw, word2vec, word_vector_size, 
        ...
        self.W_111 = nn_utils.normal_param(std=0.1, shape=(self.dim, self.dim, self.dim))
        self.W_112 = nn_utils.normal_param(std=0.1, shape=(self.dim, self.dim, self.dim))
        self.W_113 = nn_utils.normal_param(std=0.1, shape=(self.dim, self.dim, self.dim))
        self.W_12 = nn_utils.normal_param(std=0.1, shape=(self.dim, 3 * self.dim ))
        ...
        self.params = [self.W_inp_res_in, self.W_inp_res_hid, self.b_inp_res, 
                  ...
                  #self.W_1,
                  self.W_111, self.W_112, self.W_113, self.W_12, 
                  self.W_2, self.b_1, self.b_2, self.W_a]
